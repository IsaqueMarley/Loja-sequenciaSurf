...
function salvarEdicao() {
    ...
    var preco = document.getElementById('editPreco').value;
...
function editarProduto(event) {
    ...
    document.getElementById('editPreco').value = linha.querySelector('.pegar_preco_produto').textContent;
    document.getElementById('editQuantidade').value = linha.querySelector('.pegar_quantidade_produto').textContent;
...
function salvarNovoProduto() {
    ...
    var quantidade = document.getElementById('novoQuantidade').value;
