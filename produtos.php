...
<head>
  ...
  <!-- SCRIPTS -->
  <script src="assets/js/produtos/produtos.js" defer></script>
...
<body>
  ...
  <div class="container-search">
    <!-- BARRA DE PESQUISA -->
    <div class="box">
      <form class="inputs" id="searchForm">
        <input type="text" id="searchbar" name="pesquisa_text" placeholder="Encontre roupas, pranchas, acessórios...">
        <input type="submit" name="pesquisa" value="Pesquise"></input>
      </form>
    </div>
  </div>
  ...
  <section id="produtos">
    ...
    <div class="produtos">
      ...
      $query = "SELECT * FROM produtos ORDER BY idprodutos ASC";
